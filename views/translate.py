"""AI 통역사 화면: 텍스트/음성 번역과 사진 OCR 번역을 제공한다."""

import streamlit as st
import time
from utils import openai_helper
try:
    # 선택적 의존성: 설치되어 있으면 마이크 녹음을 제공
...
def render():
    ...
    # API 키가 없으면 기능을 사용할 수 없으므로 안내 후 종료
    ...
    with tab_text:
        ...
        with col1:
            # 세션 상태 값을 기본값으로 사용해 음성 전사 결과를 반영
